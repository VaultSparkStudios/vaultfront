...
function applyVaultFrontBranding(text: string): string {
  return text
    .replace(/\bopenfront\.io\b/gi, "VaultFront")
    .replace(/\bopenfront\b/gi, "VaultFront");
}
...
export const translateText = (
  ...
  if (
    ...
    return applyVaultFrontBranding(message);
  }
  ...
  try {
    ...
    return applyVaultFrontBranding(formatter.format(resolvedParams) as string);
  } catch (e) {
