    ...
    return html`
      ...
      >
        <div class="flex flex-col items-center justify-center">
          ...
          <div
            id="game-version"
            class="l-header__highlightText text-center text-cyan-200/80"
          ></div>
        </div>
        <button
          class="nav-menu-item ${
            currentPage === "page-play" ? "active" : ""
          } text-white/70 hover:text-amber-300 font-bold tracking-widest uppercase cursor-pointer transition-colors [&.active]:text-amber-300"
          data-page="page-play"
          data-i18n="main.play"
        ></button>
