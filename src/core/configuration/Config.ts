...
export interface VaultConvoyRewardTuning {
  minGoldReward: number;
  minTroopsReward: number;
  lowSignalEarlyWindowTicks: number;
  riskMultiplierBase: number;
  riskMultiplierScale: number;
  rewardMultiplierMin: number;
  rewardMultiplierMax: number;
  baselineGoldOwnerStrengthScale: number;
  baselineGoldAvgStrengthScale: number;
  baselineGoldRiskBase: number;
  baselineGoldRiskScale: number;
  distanceGoldMin: number;
  distanceGoldOwnerStrengthScale: number;
  distanceGoldFlat: number;
  distanceGoldRiskBase: number;
  distanceGoldRiskScale: number;
  troopsSqrtGoldScale: number;
  troopsDistanceBase: number;
  troopsDistanceRiskScale: number;
}

export interface VaultRuntimeExperiment {
