  ...
  createExec(intent: StampedIntent): Execution {
    ...
    switch (intent.type) {
      ...
      case "set_resource_focus":
        return new SetResourceFocusExecution(player, intent.focus);
      case "vault_convoy_command":
        return new VaultConvoyCommandExecution(player, intent.command);
      case "defense_factory_command":
        return new DefenseFactoryCommandExecution(player, intent.command);
      case "vault_role_ping":
        return new VaultRolePingExecution(player, intent.ping);
      default:
