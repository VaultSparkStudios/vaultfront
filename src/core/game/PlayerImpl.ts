...
export class PlayerImpl implements Player {
  ...
  private _goldTroopFocus: number;
  ...
  constructor(
    ...
    this._goldTroopFocus = within(
      mg.config().nationGoldTroopEmphasis(),
      0,
      100,
    );
  ...
  toUpdate(): PlayerUpdate {
    ...
    return {
      ...
      gold: this._gold,
      goldTroopFocus: this.goldTroopFocus(),
      troops: this.troops(),
  ...
  goldTroopFocus(): number {
    return this._goldTroopFocus;
  }

  setGoldTroopFocus(focus: number): void {
    this._goldTroopFocus = within(focus, 0, 100);
  }
