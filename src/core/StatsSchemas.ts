...
export const VaultFrontPlayerStatsSchema = z
  .object({
    vaultCaptures: BigIntStringSchema.optional(),
    vaultPassiveGold: BigIntStringSchema.optional(),
    vaultPassivePayouts: BigIntStringSchema.optional(),
    vaultConvoysLaunched: BigIntStringSchema.optional(),
    ...
    focusSamples: BigIntStringSchema.optional(),
    focusTotal: BigIntStringSchema.optional(),
    convoyReroutes: BigIntStringSchema.optional(),
    convoyEscortCommands: BigIntStringSchema.optional(),
    jamBreakerUses: BigIntStringSchema.optional(),
    surgeActivations: BigIntStringSchema.optional(),
    minute8Behind: BigIntStringSchema.optional(),
...
export const PlayerStatsSchema = z
  .object({
    ...
    vaultfront: VaultFrontPlayerStatsSchema,
  })
  .optional();
