...
### Step 8.6 · Doctor Score + Render Startup Brief _(run every closeout)_
...
### Step 8.7 · State Vector _(run every closeout)_
...
### Step 8.8 · Entropy + Genome _(run every closeout)_
...
### Step 8.9 · Session Plan _(run every closeout)_
...
### Step 8.10 · Genius List Refresh _(run every closeout)_
...
### Step 8.11 · Protocol Changelog _(run every closeout)_
...
### Step 8.12 · Portfolio Freshness Check _(run when IGNIS or content state changed)_
