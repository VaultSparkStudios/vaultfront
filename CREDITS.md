...
VaultFront is a derived fork of OpenFrontIO and remains licensed under AGPL-3.0 for source code.

- Upstream project: [openfrontio/OpenFrontIO](https://github.com/openfrontio/OpenFrontIO)
- Upstream contributors: [OpenFrontIO contributors graph](https://github.com/openfrontio/OpenFrontIO/graphs/contributors)
- Current fork repository: [VaultSparkStudios/VaultFront](https://github.com/VaultSparkStudios/VaultFront)

This repository preserves upstream attribution and license obligations. See [LICENSE](LICENSE), [LICENSE-ASSETS](LICENSE-ASSETS), and [LICENSING.md](LICENSING.md).
