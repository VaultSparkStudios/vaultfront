...
node scripts/ark.mjs ship --type repo-question --to '{"question":"...","replyTo":"my-slug"}' < slug > --payload
node scripts/ark.mjs ship --type agent-handoff --to '{"intent":"...","openFiles":["..."]}' < slug > --payload
```
